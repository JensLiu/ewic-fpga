...
#
# Script generated by Vivado on Thu Mar 19 15:46:17 CET 2026
# SW Build 4126759 on Thu Feb  8 23:52:05 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : uart_fifo.sh
...
#
# Usage        : uart_fifo.sh
#                uart_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_fifo.sh [-reset_run]
#                uart_fifo.sh [-reset_log]
#                uart_fifo.sh [-help]
#
...
#                script (type 'uart_fifo.sh -help' for more information).
#
...
# script info
echo -e "uart_fifo.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.uart_fifo xil_defaultlib.glbl -o uart_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./uart_fifo_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jens/Documents/academic/n3cat/vivado_projects/uart_design/uart_design.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key uart_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc uart_fifo_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_fifo.sh [-help]\n\
Usage: uart_fifo.sh [-step]\n\
Usage: uart_fifo.sh [-lib_map_path]\n\
Usage: uart_fifo.sh [-reset_run]\n\
Usage: uart_fifo.sh [-reset_log]\n\
Usage: uart_fifo.sh [-keep_index]\n\
Usage: uart_fifo.sh [-noclean_files]\n\n\
