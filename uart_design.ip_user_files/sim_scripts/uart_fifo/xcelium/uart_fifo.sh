...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.uart_fifo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.uart_fifo -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jens/Documents/academic/n3cat/vivado_projects/uart_design/uart_design.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log uart_fifo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
