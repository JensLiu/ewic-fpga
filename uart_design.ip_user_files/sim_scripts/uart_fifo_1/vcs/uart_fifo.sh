...
#
# Script generated by Vivado on Tue Apr 28 18:00:44 CEST 2026
...
# script info
echo -e "uart_fifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alfonso/TFM/ewic-fpga_v2/ewic-fpga/uart_design.cache/compile_simlib/vcs"
  fi
